...
- `images/`：App 圖示（`sidebell.webp`、`harbormi.webp`、`shishang.webp`，192×192 WebP，頁面上顯示為 64/80px）。
- `README.md`：給人看的專案說明。
...
- App 圖示放在 `images/`，以相對路徑引用（`<img class="appicon" loading="lazy" decoding="async" src="images/xxx.webp">`）。不要改回 base64 內嵌。新增圖示時請用 192×192 WebP。
